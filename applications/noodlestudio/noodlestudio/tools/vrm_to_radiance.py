...
#   Vrm To Radiance
#
#   Implements vrm to radiance functionality.
#
# ──────────────────────────────────────────────────────────────
# MODULE:   applications.noodlestudio.tools.vrm_to_radiance
# PURPOSE:  Vrm To Radiance
# LAYER:    Studio / Tools
# ──────────────────────────────────────────────────────────────
#
# KEY CLASSES:
#   filter_trained_gaussians(), compute_adaptive_scales(), densify_mesh()
#
# ──────────────────────────────────────────────────────────────
