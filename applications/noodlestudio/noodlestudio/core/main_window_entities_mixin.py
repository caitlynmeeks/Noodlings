...
Contains:
- add_noodling, add_object, add_room: Add entities to stage
- create_empty_*: Create empty entities via Create menu
- create_specialized_*: Create entities with presets
- Ensemble operations
