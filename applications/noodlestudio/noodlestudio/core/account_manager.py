...
#
#   ================================ Handles user authenticat...
#
# ──────────────────────────────────────────────────────────────
# MODULE:   applications.noodlestudio.core.account_manager
# PURPOSE:  Account Manager for NoodleStudio
# LAYER:    Studio / Core
# ──────────────────────────────────────────────────────────────
#
# KEY CLASSES:
#   UserProfile, AvatarAssetLocation, AvatarMetadata, AccountManager, OAuthCallbackServer
#
# ──────────────────────────────────────────────────────────────
