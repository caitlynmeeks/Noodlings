...
- Camera view generation (importance-weighted)
- Training image rendering
- OpenSplat training control
- PLY to radiance conversion

Used by ScriptedFacets in training assemblies.
"""
