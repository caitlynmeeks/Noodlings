...
Contains:
- populate_stage_selector: Populate dropdown with stages/rooms
- on_stage_changed: Handle stage selection
- teleport_to_stage: Send teleport command
- _restore_stage_selector: Restore selection on cancel
