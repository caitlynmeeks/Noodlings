    ...
    async def cmd_brenda(self, user_id: str, args: str) -> Dict:
        ...
        if not args:
            return {
                'success': False,
                'output': (
                    "🌿 BRENDA - Natural Language Interface\n\n"
                    "Parameter Tweaking:\n"
                    "  @brenda make <agent> <adjective> - chattier, quieter, calm, alpha, hippie, etc.\n"
                    "  @brenda reset <agent> - reload recipe defaults\n"
                    "  @brenda vibe check <agent> - show current settings\n"
                    "  @brenda undo <agent> - undo last Brenda change\n"
                    "  @brenda pass the joint - 🌿\n\n"
                    "Play Generation:\n"
                    "  @brenda write play <story> - generate a play from your idea\n"
                    "  @brenda plays list - show all available plays\n"
                    "  @brenda plays start <name> - start a play\n"
                    "  @brenda plays stop <name> - stop a running play\n"
                    "  @brenda plays next <name> - advance to next scene (manual trigger)\n"
                    "  @brenda plays delete <name> - delete a play\n\n"
                    "Examples:\n"
                    "  @brenda make Toad chattier\n"
                    "  @brenda write play where Toad finds a UFO and chases an alien\n"
                    "  @brenda plays list"
                ),
                'events': []
            }
